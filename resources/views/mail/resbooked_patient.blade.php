...
<body>
    <div>
        ...
        <table>
            ...
            <tr>
                <td>Passwort:</td>
                @if (isset($patient['new_password']))
                    <td>{{ $patient['new_password'] }}</td>
                @else
                    <td></td>
                @endif
            </tr>
        ...
        <p>
            Bitte stellen Sie sicher, dass Sie pünktlich zum Termin erscheinen und alle relevanten Unterlagen
            bereithalten. Sollten Sie den Termin verschieben oder absagen müssen, kontaktieren Sie uns bitte so bald wie
            möglich.
        </p>
        <p>
            Falls Sie Fragen haben oder weitere Informationen benötigen, stehen wir Ihnen jederzeit zur Verfügung.

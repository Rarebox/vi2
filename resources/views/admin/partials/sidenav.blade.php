<div class="sidebar" data-background="">
    <button class="res-sidebar-close-btn"><i class="las la-times"></i></button>
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{ route('admin.dashboard') }}" class="sidebar__main-logo"><img src="{{ asset('assets/Logo.png') }}"
                    alt="@lang('image')">
            </a>
            ...
            <ul class="sidebar__menu">
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item ">
                                <a href="{{ route('admin.patient.create') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Create Patient')</span>
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="">
                        ...
                        <span class="menu-title">@lang('Manage Forms')</span>
                    </a>
                    <div class="sidebar-submenu ">
                        <ul>
                            <li class="sidebar-menu-item">

...
var Virtualizer = class {
  constructor(opts) {
    ...
    this.getMeasurements = memo(
      ...
      ({ count, paddingStart, scrollMargin, getItemKey, enabled }, itemSizeCache) => {
        ...
        for (let i8 = min; i8 < count; i8++) {
          let measureElement2 = (_a = this.measurementsCache[i8]) == null ? void 0 : _a.measureElement;
          if (!measureElement2) {
            measureElement2 = (node) => {
              const key2 = getItemKey(i8);
    ...
    this._measureElement = (node, entry) => {
      const i8 = this.indexFromElement(node);
      const item = this.getMeasurements()[i8];
      ...
      this.resizeItem(i8, this.options.measureElement(node, entry, this));
    };

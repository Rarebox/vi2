import {
  ...
  k,
  te
} from "./chunk-E3LFVGXI.js";
import "./chunk-7NGEAVBS.js";
import "./chunk-6OWDU3EK.js";
import {
  require_react
...
var X = function({ children: d, title: c }) {
  let s = (0, import_react.useContext)(A), p = (0, import_react.useMemo)(() => s.createProvider(), [s]);
...
var $ = (0, import_react3.forwardRef)(({ children: d, as: c = "a", data: s = {}, href: p, method: a = "get", preserveScroll: S = false, preserveState: f = null, replace: P = false, only: u = [], except: g = [], headers: l = {}, queryStringArrayFormat: e = "brackets", onClick: i = F, onCancelToken: o = F, onBefore: y = F, onStart: T = F, onProgress: H = F, onFinish: h = F, onCancel: M = F, onSuccess: x = F, onError: w = F, ...R }, I) => {
  let v = (0, import_react3.useCallback)((r) => {
    i(r), te(r) && (r.preventDefault(), Fe.visit(p, { data: s, method: a, preserveScroll: S, preserveState: f ?? a !== "get", replace: P, only: u, except: g, headers: l, onCancelToken: o, onBefore: y, onStart: T, onProgress: H, onFinish: h, onCancel: M, onSuccess: x, onError: w }));
...
<Link href="${p}" method="${a}" as="button">...</Link>`), (0, import_react3.createElement)(c, { ...R, ...c === "a" ? { href: p } : {}, ref: I, onClick: v }, d);
});
...
function O({ children: d, initialPage: c, initialComponent: s, resolveComponent: p, titleCallback: a, onHeadUpdate: S }) {
  let [f, P] = (0, import_react5.useState)({ component: s || null, page: c, key: null }), u = (0, import_react5.useMemo)(() => Y(typeof window > "u", a || ((l) => l), S || (() => {
  })), []);
  if ((0, import_react5.useEffect)(() => {
    ...
    } }), Fe.on("navigate", () => u.forceUpdate());
  }, []), !f.component) return (0, import_react5.createElement)(A.Provider, { value: u }, (0, import_react5.createElement)(E.Provider, { value: f.page }, null));
  ...
  return (0, import_react5.createElement)(A.Provider, { value: u }, (0, import_react5.createElement)(E.Provider, { value: f.page }, g({ Component: f.component, key: f.key, props: f.page.props })));
}
...
function W(d, c) {
  ...
  let v = (0, import_react7.useCallback)((t, n, r = {}) => {
    ...
    t === "delete" ? Fe.delete(n, { ...k2, data: I(u) }) : Fe[t](n, I(u), k2);
  }, [u, e]);
  return { data: u, setData(t, n) {
    g(typeof t == "string" ? { ...u, [t]: n } : typeof t == "function" ? (r) => t(r) : t);
  }, isDirty: !(0, import_lodash.default)(u, a), errors: l, hasErrors: i, processing: y, progress: H, wasSuccessful: M, recentlySuccessful: w, transform(t) {
    I = t;
  }, setDefaults(t, n) {
    ...
    e((n) => {
      let r = Object.keys(n).reduce((k2, m) => ({ ...k2, ...t.length > 0 && !t.includes(m) ? { [m]: n[m] } : {} }), {});
